...
<div class="page">
    ...
    <a href="./?page=add_Supervisor" class="btn-download">
...
<div class="DataTable">
    ...
    <table>
        ...
        <tbody>
            <?php
            // Fetch data from the supervisor table
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><div class='image-container'><img src='".validate_image($row["image"])."' alt='Supervisor Image'></div></td>";
                    echo "<td>".$row["dateAdded"]."</td>";
                    echo "<td><a href='./?page=add_Supervisor&id=".$row["id"]."'>Update</a> | <a href='delete.php?table=supervisor&id=".$row["id"]."' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>"; // Action buttons
                    echo "</tr>";
                }
            } else {
