...
<div class="page">
    ...
    <a href="./?page=add_Workshop" class="btn-download">
        <i class='bx bxs-cloud-download'></i>
        <span class="text">Add New Workshop</span>
    </a>
</div>
...
<div class="DataTable">
    ...
    <table>
        ...
        <tbody>
            <?php
            // Fetch data from the workshop table
            $sql = "SELECT * FROM worshop";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><div class='image-container'><img src='".validate_image($row["image"])."' alt='Workshop Image'></div></td>";
                    echo "<td>".$row["dateAdded"]."</td>";
                    echo "<td><a href='./?page=add_Workshop&id=".$row["workshop_id"]."'>Update</a> | <a href='delete.php?table=worshop&id=".$row["workshop_id"]."' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>"; // Action buttons
                    echo "</tr>";
                }
            } else {
